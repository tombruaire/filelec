			...
			<div class="card border border-5 reveal-1 mb-5" style="background-color: #ADD8E6; border-color: #ADD8E6!important;">
				...
				<div class="card-body" style="border-radius: .25rem!important; background-color: #ADD8E6;">
					<form method="post" action="">
						<div class="mb-3">
							<label for="email" class="form-label fw-bold">Adresse email (<i>Obligatoire</i>)</label>
							<input type="email" name="email" id="email" class="form-control">
						</div>
						<div class="mb-3">
							<label for="sujet" class="form-label fw-bold">Sujet du message (<i>Obligatoire</i>)</label>
							<input type="text" name="sujet" id="sujet" class="form-control">
						</div>
						<div class="mb-3">
							<label for="message" class="form-label fw-bold">Message (<i>Obligatoire</i>)</label>
							<textarea name="message" id="message" class="form-control"></textarea>
						</div>
						<div class="d-flex justify-content-center">
							<button type="reset" class="btn btn-lg btn-danger me-2">
